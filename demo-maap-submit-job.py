...
if __name__ == '__main__':
    deserialized_params = json.loads('{"regnm": "NA", "bbox": "[0,0,0,0]", "tst": "[]", "ted": "[]", "operation": "--data-update"}')
    pargs = ['eis-feds-dask-coordinator-v3', '1.2.1', 'gcorradini', 'maap-dps-eis-worker-32gb', 'ubuntu']
    print(f"[ ARGS ]: {pargs}")
